<?php
/*
Plugin Name: Picasso Artwork 
*/

function ab_setup_post_type() {
 
    // Register our "book" custom post type
    register_post_type( 'Picasso_Artwork', 
      array(
        'labels' => array(
          'name' => __('Picasso Artwork'),
...
add_action( 'init', 'ab_setup_post_type' );
...
register_activation_hook( __FILE__, 'ab_install' );
